...
import net.zam.castingcaving.registry.ZAMArmorMaterial;
...
public class MarineArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ZAMArmorMaterial.MARINE, List.of(new MobEffectInstance(Holder.direct(ZAMEffects.BLESSING_OF_THE_DEEP.get()), Integer.MAX_VALUE, 1, false, false))).build();

    public MarineArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
